...
export const metadata: Metadata = {
  ...
  description:
    "Premium quality Turkish apples for small and medium wholesalers globally. Fuji, Gala, Red, Golden Delicious & Granny Smith — export-grade, fresh from orchards in Isparta, Karaman and Niğde.",
  keywords: [
    "apples from Turkey",
